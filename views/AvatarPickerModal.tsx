              ...
              <div className="space-y-6">
                ...
                {!isGenerating && (
                  <button 
                    ...
                    className="w-full py-6 bg-yellow-400 text-indigo-950 font-black rounded-[2rem] shadow-[0_8px_0_0_rgba(30,27,75,1)] border-[6px] border-indigo-950 text-lg uppercase italic tracking-tighter flex items-center justify-center gap-4 transition-all hover:translate-y-1 active:translate-y-2 active:shadow-none"
                  >
