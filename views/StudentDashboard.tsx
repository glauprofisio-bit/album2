    ...
    <div className="fixed inset-0 bg-indigo-950/95 backdrop-blur-xl z-[5000] flex items-center justify-center p-4">
      <div className="bg-white rounded-[4rem] w-full max-w-md border-[12px] border-indigo-950 shadow-2xl overflow-hidden relative">
        ...
        <div className="p-7 text-center">
          ...
          <p className="text-indigo-400 font-black uppercase tracking-widest text-[10px] mt-2">
            Semana {week}
          </p>
        </div>
        ...
        <div className="px-7 pb-8">
          ...
          >
            ...
            <div className="absolute inset-0">
              <div
                className={`w-full h-full flex flex-col border-4 ${getRarityStyle(sticker?.rarity).frame} rounded-[2rem] overflow-hidden`}
              >
                ...
                <div className="p-4 bg-white text-center border-t-4 border-slate-50">
                  ...
                  <span
                    className={`inline-block mt-2 px-5 py-2 rounded-full text-white font-black text-[9px] uppercase tracking-widest ${getRarityStyle(sticker?.rarity).badge}`}
                  >
...
}; // ✅ só isso aqui. NÃO tem outro "};" depois.
